...
INSERT INTO `brand` VALUES ('sodiyam chloride',1,'jenish','06/03/2023');
...
CREATE TABLE `inflow` (
  `id` int NOT NULL AUTO_INCREMENT,
  `inflowid` varchar(45) DEFAULT NULL,
  ...
  `fillby` varchar(45) DEFAULT NULL,
  `approveby` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='nflow';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `inflow` VALUES (1,NULL,'jenish',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,NULL,'jenish',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,NULL,'jenish',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,NULL,'jenish','h','sodiyam chloride','8632','up','863',NULL,'5666',0,'8632','658','8652','g',NULL,NULL,NULL),(5,NULL,'jenish','h','sodiyam chloride','78','up','788',NULL,'9',899,'8632','59','88','g',NULL,NULL,NULL);
...
INSERT INTO `newcat` VALUES (1,'sodiyam chloride','sodiyam chloride','g','h','up','2500','07/03/2023'),(3,'hello','sodiyam chloride','g','h','up','7800','08/03/2023');
...
-- Dump completed on 2023-03-13  9:34:20
